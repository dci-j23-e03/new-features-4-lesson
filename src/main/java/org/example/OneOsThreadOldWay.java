...
public class OneOsThreadOldWay {
  ...
  public static void main(String[] args) {
    ...
    Thread v1 = Thread.ofPlatform().name("long-running-thread").start(
        () -> {
    ...
    Thread v2 = Thread.ofPlatform().name("small-entertainment-thread").start(
        () -> {
